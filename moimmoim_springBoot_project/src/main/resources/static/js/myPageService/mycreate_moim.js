//open//
// 변수 지정
var slideWrapper =  document.getElementsByClassName('box2'),
...
function updateNav(){
	...
	if(currentIndex > (slideCount/4) - 1){
...
//closed//
// 변수 지정
var slideWrapper2 =  document.getElementsByClassName('box3'),
...
function updateNav2(){
    ...
    if(currentIndex2 > (slideCount2/4) - 1){
